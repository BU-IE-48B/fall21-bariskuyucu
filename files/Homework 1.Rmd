...
In gesture vocabulary figure in our pdf, first image has a sharp corner. In our plot we don't have the sharp cornet but the shape is similar.
...
In gesture vocabulary figure in our pdf, third image is a straight line. In our plot the image is like a straight line but at the end of it, it has a litte curve.
...
In gesture vocabulary figure in our pdf, fourth image is a straight line. In our plot the image is like a straight line but at the beginning but later, it becomes a curve.
...
In gesture vocabulary figure in our pdf, fifth image is a straight line. In our plot the image is like a straight line but at the beginning but later, it becomes a curve.
...
In gesture vocabulary figure in our pdf, sixth image is a straight line. In our plot the image is like a straight line but at the beginning but later, it has some oscillations in the end.
